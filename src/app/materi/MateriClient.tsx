...
export default function MateriClient({ materiModules }: { materiModules: any[] }) {
  ...
  const progressPercent = materiModules.length > 0 
    ? Math.round((completed.length / materiModules.length) * 100) 
    : 0;
