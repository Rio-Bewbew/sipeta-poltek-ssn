...
import { caseStudies, type CaseStudy } from "@/data/kasus";
...
function CaseCard({
  ...
  const correctOption = kasus.pilihan.find((p) => p.benar);
  const isCorrect = selected
    ? kasus.pilihan.find((p) => p.id === selected)?.benar
    : false;
    ...
    <div className="relative min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <p className="text-teks/60 max-w-2xl mx-auto">
          Analisis 4 skenario nyata dan pilih tindakan yang sesuai
