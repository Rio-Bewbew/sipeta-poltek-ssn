...
import { quizQuestions, type QuizQuestion } from "@/data/kuis";
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-8">
        ...
        <p className="text-teks/60">
          Jawab 10 soal untuk menguji pemahaman Anda tentang peraturan
          pembinaan
        </p>
      </div>
        ...
        >
          <div className="p-6 md:p-8">
            ...
            <div className="space-y-3">
              {currentQuestion.pilihan.map((pilihan, i) => {
                let optionStyle =
